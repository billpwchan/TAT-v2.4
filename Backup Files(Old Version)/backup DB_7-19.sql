...
CREATE TABLE test_step_has_script (idtest_step_has_script  integer, script_idScript integer not null, test_step_idtest_step integer not null, execution_order tinyint not null, primary key (idtest_step_has_script));
...
CREATE TABLE test_step_has_requirement (test_step_idtest_step integer not null, requirement_idrequirement integer not null, primary key (requirement_idrequirement, test_step_idtest_step));
CREATE TABLE test_step (idtest_step  integer, test_case_idtest_case integer, writer varchar(20), human_stimuli varchar(65535), human_check varchar(65535), creation_date varchar(10), edition_date varchar(10), step_order tinyint, blocking_step boolean, step_condition boolean, primary key (idtest_step));
...
CREATE TABLE test_case (idtest_case  integer, test_case_title varchar(30), writter varchar(20), case_internal_version tinyint, creation_date varchar(10), edition_date varchar(10), test_case_identification varchar(30), test_case_version varchar(10), project varchar(10), type_of_test varchar(20), category_of_test varchar(20), location varchar(20), environment varchar(20), test_objective varchar(65535), total_steps tinyint, writter_email varchar(30), writing_status varchar(25), test_method_iadt varchar(15), blocking tinyint, internal_comments varchar(65535), test_case_source varchar(50), primary key (idtest_case));
...
CREATE TABLE test_campaign_test_case (test_campaign_idtest_campaign integer not null, test_case_idtest_case integer not null, case_order tinyint not null, primary key (test_campaign_idtest_campaign, test_case_idtest_case, case_order));
...
CREATE TABLE test_campaign_has_user (user_idUser integer not null, test_campaign_idtest_campaign integer not null, primary key (test_campaign_idtest_campaign, user_idUser));
CREATE TABLE test_campaign (idtest_campaign  integer, reference varchar(45), System varchar(20), writter varchar(20), campaign_version integer, description varchar(65535), comments varchar(65535), creation_date varchar(10), edition_date varchar(10), software_sut_release varchar(20), number_test_case integer, regression_thread tinyint, writer_email varchar(50), primary key (idtest_campaign));
...
CREATE TABLE step_executions_result (step_executions_idstep_executions integer not null, iteration_number tinyint not null, result varchar(6) not null, comment varchar(65535), primary key (step_executions_idstep_executions, iteration_number));
...
CREATE TABLE step_executions (idstep_executions  integer, case_executions_idcase_executions integer not null, test_step_idtest_step integer, step_order tinyint, primary key (idstep_executions));
...
CREATE TABLE script_has_parameters (idscript_has_parameters  integer, parameters_idparameters integer not null, script_idScript integer not null, param_order tinyint not null, primary key (idscript_has_parameters));
...
CREATE TABLE script_has_been_configured (idscript_has_been_configured  integer, parameters_idparameters integer not null, test_step_has_script_idtest_step_has_script integer not null, param_order tinyint not null, is_configured tinyint, value varchar(150), value_path varchar(150), primary key (idscript_has_been_configured));
INSERT INTO `script_has_been_configured` VALUES (604,10,128,0,1,'Wait for modbus connection','Constant');
INSERT INTO `script_has_been_configured` VALUES (605,36,128,1,1,'5','Constant');
INSERT INTO `script_has_been_configured` VALUES (606,10,129,0,1,'Connect Modbus','Constant');
INSERT INTO `script_has_been_configured` VALUES (607,21,129,3,1,'1','Constant');
INSERT INTO `script_has_been_configured` VALUES (608,23,129,1,1,'128.62.230.184','Constant');
INSERT INTO `script_has_been_configured` VALUES (609,22,129,4,1,'AI','Constant');
INSERT INTO `script_has_been_configured` VALUES (610,20,129,2,1,'502','Constant');
INSERT INTO `script_has_been_configured` VALUES (611,30,130,2,1,'0','Constant');
INSERT INTO `script_has_been_configured` VALUES (612,29,130,1,1,'@&Number_1985','Excel file');
INSERT INTO `script_has_been_configured` VALUES (613,10,130,0,1,'Trigger Low Level','Constant');
INSERT INTO `script_has_been_configured` VALUES (614,30,131,2,1,'0','Constant');
INSERT INTO `script_has_been_configured` VALUES (615,29,131,1,1,'@&Number_1985','Excel file');
INSERT INTO `script_has_been_configured` VALUES (616,10,131,0,1,'Trigger Low Level','Constant');
INSERT INTO `script_has_been_configured` VALUES (617,16,132,2,1,'@&Number_1265','Excel file');
INSERT INTO `script_has_been_configured` VALUES (618,16,132,3,1,'@&Number_1195','Excel file');
INSERT INTO `script_has_been_configured` VALUES (619,16,132,5,1,'@&Number_115','Excel file');
INSERT INTO `script_has_been_configured` VALUES (620,16,132,4,1,'@&Number_1145','Excel file');
INSERT INTO `script_has_been_configured` VALUES (621,16,132,0,1,'@&Number_1155','Excel file');
INSERT INTO `script_has_been_configured` VALUES (622,16,132,6,1,'@&Number_1275','Excel file');
INSERT INTO `script_has_been_configured` VALUES (623,16,132,1,1,'@&Number_1225','Excel file');
INSERT INTO `script_has_been_configured` VALUES (624,16,133,0,1,'@&Number_1155','Excel file');
INSERT INTO `script_has_been_configured` VALUES (625,16,133,6,1,'@&Number_1295','Excel file');
INSERT INTO `script_has_been_configured` VALUES (626,16,133,5,1,'@&Number_115','Excel file');
INSERT INTO `script_has_been_configured` VALUES (627,16,133,1,1,'@&Number_1225','Excel file');
INSERT INTO `script_has_been_configured` VALUES (628,16,133,3,1,'@&Number_1195','Excel file');
INSERT INTO `script_has_been_configured` VALUES (629,16,133,2,1,'@&Number_1285','Excel file');
INSERT INTO `script_has_been_configured` VALUES (630,16,133,4,1,'@&Number_1145','Excel file');
INSERT INTO `script_has_been_configured` VALUES (631,30,134,2,1,'@&Number_1995','Excel file');
INSERT INTO `script_has_been_configured` VALUES (632,10,134,0,1,'Trigger High Level','Constant');
INSERT INTO `script_has_been_configured` VALUES (633,29,134,1,1,'@&Number_1985','Excel file');
INSERT INTO `script_has_been_configured` VALUES (634,43,135,2,1,'1','Constant');
INSERT INTO `script_has_been_configured` VALUES (635,45,135,4,1,'1','Constant');
INSERT INTO `script_has_been_configured` VALUES (636,29,135,1,1,'@&Number_2987','Excel file');
INSERT INTO `script_has_been_configured` VALUES (637,44,135,3,1,'1','Constant');
INSERT INTO `script_has_been_configured` VALUES (638,10,135,0,1,'Trigger Level 3','Constant');
INSERT INTO `script_has_been_configured` VALUES (639,16,136,1,1,'@&Number_2227','Excel file');
INSERT INTO `script_has_been_configured` VALUES (640,16,136,5,1,'@&Number_217','Excel file');
INSERT INTO `script_has_been_configured` VALUES (641,16,136,2,1,'@&Number_2327','Excel file');
INSERT INTO `script_has_been_configured` VALUES (642,16,136,6,1,'@&Number_2337','Excel file');
INSERT INTO `script_has_been_configured` VALUES (643,16,136,4,1,'@&Number_2147','Excel file');
INSERT INTO `script_has_been_configured` VALUES (644,16,136,0,1,'@&Number_2157','Excel file');
INSERT INTO `script_has_been_configured` VALUES (645,16,136,3,1,'@&Number_2187','Excel file');
INSERT INTO `script_has_been_configured` VALUES (646,16,137,4,1,'@&Number_2147','Excel file');
INSERT INTO `script_has_been_configured` VALUES (647,16,137,6,1,'@&Number_2297','Excel file');
INSERT INTO `script_has_been_configured` VALUES (648,16,137,3,1,'@&Number_2187','Excel file');
INSERT INTO `script_has_been_configured` VALUES (649,16,137,1,1,'@&Number_2227','Excel file');
INSERT INTO `script_has_been_configured` VALUES (650,16,137,0,1,'@&Number_2157','Excel file');
INSERT INTO `script_has_been_configured` VALUES (651,16,137,5,1,'@&Number_217','Excel file');
INSERT INTO `script_has_been_configured` VALUES (652,16,137,2,1,'@&Number_2287','Excel file');
INSERT INTO `script_has_been_configured` VALUES (653,43,138,2,1,'0','Constant');
INSERT INTO `script_has_been_configured` VALUES (654,29,138,1,1,'@&Number_2987','Excel file');
INSERT INTO `script_has_been_configured` VALUES (655,45,138,4,1,'1','Constant');
INSERT INTO `script_has_been_configured` VALUES (656,10,138,0,1,'Trigger Level 1','Constant');
INSERT INTO `script_has_been_configured` VALUES (657,44,138,3,1,'1','Constant');
INSERT INTO `script_has_been_configured` VALUES (658,16,139,0,1,'@&Number_2157','Excel file');
INSERT INTO `script_has_been_configured` VALUES (659,16,139,3,1,'@&Number_2187','Excel file');
INSERT INTO `script_has_been_configured` VALUES (660,16,139,1,1,'@&Number_2227','Excel file');
INSERT INTO `script_has_been_configured` VALUES (661,16,139,5,1,'@&Number_217','Excel file');
INSERT INTO `script_has_been_configured` VALUES (662,16,139,2,1,'@&Number_2267','Excel file');
INSERT INTO `script_has_been_configured` VALUES (663,16,139,6,1,'@&Number_2277','Excel file');
INSERT INTO `script_has_been_configured` VALUES (664,16,139,4,1,'@&Number_2147','Excel file');
INSERT INTO `script_has_been_configured` VALUES (665,44,140,3,1,'0','Constant');
INSERT INTO `script_has_been_configured` VALUES (666,45,140,4,1,'1','Constant');
INSERT INTO `script_has_been_configured` VALUES (667,43,140,2,1,'0','Constant');
INSERT INTO `script_has_been_configured` VALUES (668,10,140,0,1,'Trigger 0','Constant');
INSERT INTO `script_has_been_configured` VALUES (669,29,140,1,1,'@&Number_2987','Excel file');
INSERT INTO `script_has_been_configured` VALUES (670,29,141,1,1,'@&Number_2987','Excel file');
INSERT INTO `script_has_been_configured` VALUES (671,45,141,4,1,'1','Constant');
INSERT INTO `script_has_been_configured` VALUES (672,10,141,0,1,'Trigger level 2','Constant');
INSERT INTO `script_has_been_configured` VALUES (673,43,141,2,1,'1','Constant');
INSERT INTO `script_has_been_configured` VALUES (674,44,141,3,1,'0','Constant');
INSERT INTO `script_has_been_configured` VALUES (675,16,142,3,1,'@&Number_2187','Excel file');
INSERT INTO `script_has_been_configured` VALUES (676,16,142,0,1,'@&Number_2157','Excel file');
INSERT INTO `script_has_been_configured` VALUES (677,16,142,2,1,'@&Number_2307','Excel file');
INSERT INTO `script_has_been_configured` VALUES (678,16,142,5,1,'@&Number_217','Excel file');
INSERT INTO `script_has_been_configured` VALUES (679,16,142,1,1,'@&Number_2227','Excel file');
INSERT INTO `script_has_been_configured` VALUES (680,16,142,6,1,'@&Number_2317','Excel file');
INSERT INTO `script_has_been_configured` VALUES (681,16,142,4,1,'@&Number_2147','Excel file');
INSERT INTO `script_has_been_configured` VALUES (682,45,143,4,1,'1','Constant');
INSERT INTO `script_has_been_configured` VALUES (683,43,143,2,1,'0','Constant');
INSERT INTO `script_has_been_configured` VALUES (684,10,143,0,1,'Set to 0','Constant');
INSERT INTO `script_has_been_configured` VALUES (685,29,143,1,1,'@&Number_2987','Excel file');
INSERT INTO `script_has_been_configured` VALUES (686,44,143,3,1,'0','Constant');
INSERT INTO `script_has_been_configured` VALUES (687,14,144,4,1,'scsolsshow -lEventList -r | tail -f -n 1','Constant');
INSERT INTO `script_has_been_configured` VALUES (688,12,144,2,1,'scada','Constant');
INSERT INTO `script_has_been_configured` VALUES (689,11,144,1,1,'128.59.8.205','Constant');
INSERT INTO `script_has_been_configured` VALUES (690,13,144,3,1,'scada','Constant');
INSERT INTO `script_has_been_configured` VALUES (691,15,144,5,1,'@&Buffer_Buffer_Line','Buffer list');
INSERT INTO `script_has_been_configured` VALUES (692,10,144,0,1,'Get Event line','Constant');
INSERT INTO `script_has_been_configured` VALUES (693,1,145,3,1,'@&Buffer_Buffer_Line','Buffer list');
INSERT INTO `script_has_been_configured` VALUES (694,17,145,2,1,'(?:\|(^$|([^\|]*))){9}','Constant');
INSERT INTO `script_has_been_configured` VALUES (695,16,145,1,1,'@&Buffer_Buffer_Val','Buffer list');
INSERT INTO `script_has_been_configured` VALUES (696,10,145,0,1,'Compare Value','Constant');
INSERT INTO `script_has_been_configured` VALUES (697,33,146,4,1,'@&Number_3499','Excel file');
INSERT INTO `script_has_been_configured` VALUES (698,32,146,3,1,'@&Number_3489','Excel file');
INSERT INTO `script_has_been_configured` VALUES (699,31,146,2,1,'@&Number_3479','Excel file');
INSERT INTO `script_has_been_configured` VALUES (700,34,146,5,1,'@&Buffer_Buffer_Val','Buffer list');
INSERT INTO `script_has_been_configured` VALUES (701,10,146,0,1,'Send a value to the point','Constant');
INSERT INTO `script_has_been_configured` VALUES (702,29,146,1,1,'@&Number_3989','Excel file');
INSERT INTO `script_has_been_configured` VALUES (703,16,147,0,1,'@&Number_3159','Excel file');
INSERT INTO `script_has_been_configured` VALUES (704,16,147,4,1,'@&Number_3149','Excel file');
INSERT INTO `script_has_been_configured` VALUES (705,16,147,3,1,'@&Number_3189','Excel file');
INSERT INTO `script_has_been_configured` VALUES (706,16,147,1,1,'@&Number_3229','Excel file');
INSERT INTO `script_has_been_configured` VALUES (707,16,147,2,1,'@&Number_3269','Excel file');
INSERT INTO `script_has_been_configured` VALUES (708,16,147,5,1,'@&Number_319','Excel file');
INSERT INTO `script_has_been_configured` VALUES (709,30,148,2,1,'0','Constant');
INSERT INTO `script_has_been_configured` VALUES (710,10,148,0,1,'Trigger Low Level','Constant');
INSERT INTO `script_has_been_configured` VALUES (711,29,148,1,1,'@&Number_1985','Excel file');
INSERT INTO `script_has_been_configured` VALUES (712,16,149,4,1,'@&Number_1225','Excel file');
INSERT INTO `script_has_been_configured` VALUES (713,16,149,2,1,'@&Number_1145','Excel file');
INSERT INTO `script_has_been_configured` VALUES (714,16,149,3,1,'@&Number_1155','Excel file');
INSERT INTO `script_has_been_configured` VALUES (715,16,149,5,1,'@&Number_1265','Excel file');
INSERT INTO `script_has_been_configured` VALUES (716,16,149,0,1,'@&Number_115','Excel file');
INSERT INTO `script_has_been_configured` VALUES (717,16,149,1,1,'@&Number_1195','Excel file');
INSERT INTO `script_has_been_configured` VALUES (718,16,149,6,1,'@&Number_1275','Excel file');
INSERT INTO `script_has_been_configured` VALUES (719,30,150,2,1,'0','Constant');
INSERT INTO `script_has_been_configured` VALUES (720,10,150,0,1,'Trigger Low Level','Constant');
INSERT INTO `script_has_been_configured` VALUES (721,29,150,1,1,'@&Number_1985','Excel file');
INSERT INTO `script_has_been_configured` VALUES (722,16,151,4,1,'@&Number_1225','Excel file');
INSERT INTO `script_has_been_configured` VALUES (723,16,151,1,1,'@&Number_1195','Excel file');
INSERT INTO `script_has_been_configured` VALUES (724,16,151,0,1,'@&Number_115','Excel file');
INSERT INTO `script_has_been_configured` VALUES (725,16,151,2,1,'@&Number_1145','Excel file');
INSERT INTO `script_has_been_configured` VALUES (726,16,151,6,1,'@&Number_1295','Excel file');
INSERT INTO `script_has_been_configured` VALUES (727,16,151,3,1,'@&Number_1155','Excel file');
INSERT INTO `script_has_been_configured` VALUES (728,16,151,5,1,'@&Number_1285','Excel file');
INSERT INTO `script_has_been_configured` VALUES (729,29,152,1,1,'@&Number_1985','Excel file');
INSERT INTO `script_has_been_configured` VALUES (730,10,152,0,1,'Trigger High Level','Constant');
INSERT INTO `script_has_been_configured` VALUES (731,30,152,2,1,'@&Number_1995','Excel file');
INSERT INTO `script_has_been_configured` VALUES (732,10,153,0,1,'Trigger level 2','Constant');
INSERT INTO `script_has_been_configured` VALUES (733,44,153,3,1,'0','Constant');
INSERT INTO `script_has_been_configured` VALUES (734,43,153,2,1,'1','Constant');
INSERT INTO `script_has_been_configured` VALUES (735,29,153,1,1,'@&Number_2987','Excel file');
INSERT INTO `script_has_been_configured` VALUES (736,45,153,4,1,'1','Constant');
INSERT INTO `script_has_been_configured` VALUES (737,16,154,1,1,'@&Number_2197','Excel file');
INSERT INTO `script_has_been_configured` VALUES (738,16,154,4,1,'@&Number_2227','Excel file');
INSERT INTO `script_has_been_configured` VALUES (739,16,154,2,1,'@&Number_2147','Excel file');
INSERT INTO `script_has_been_configured` VALUES (740,16,154,0,1,'@&Number_217','Excel file');
INSERT INTO `script_has_been_configured` VALUES (741,16,154,3,1,'@&Number_2157','Excel file');
INSERT INTO `script_has_been_configured` VALUES (742,16,154,6,1,'@&Number_2317','Excel file');
INSERT INTO `script_has_been_configured` VALUES (743,16,154,5,1,'@&Number_2307','Excel file');
INSERT INTO `script_has_been_configured` VALUES (744,10,155,0,1,'Set to 0','Constant');
INSERT INTO `script_has_been_configured` VALUES (745,44,155,3,1,'0','Constant');
INSERT INTO `script_has_been_configured` VALUES (746,45,155,4,1,'1','Constant');
INSERT INTO `script_has_been_configured` VALUES (747,29,155,1,1,'@&Number_2987','Excel file');
INSERT INTO `script_has_been_configured` VALUES (748,43,155,2,1,'0','Constant');
INSERT INTO `script_has_been_configured` VALUES (749,44,156,3,1,'1','Constant');
INSERT INTO `script_has_been_configured` VALUES (750,43,156,2,1,'0','Constant');
INSERT INTO `script_has_been_configured` VALUES (751,10,156,0,1,'Trigger Level 1','Constant');
INSERT INTO `script_has_been_configured` VALUES (752,29,156,1,1,'@&Number_2987','Excel file');
INSERT INTO `script_has_been_configured` VALUES (753,45,156,4,1,'1','Constant');
INSERT INTO `script_has_been_configured` VALUES (754,16,157,3,1,'@&Number_2157','Excel file');
INSERT INTO `script_has_been_configured` VALUES (755,16,157,6,1,'@&Number_2297','Excel file');
INSERT INTO `script_has_been_configured` VALUES (756,16,157,2,1,'@&Number_2147','Excel file');
INSERT INTO `script_has_been_configured` VALUES (757,16,157,4,1,'@&Number_2227','Excel file');
INSERT INTO `script_has_been_configured` VALUES (758,16,157,0,1,'@&Number_217','Excel file');
INSERT INTO `script_has_been_configured` VALUES (759,16,157,5,1,'@&Number_2287','Excel file');
INSERT INTO `script_has_been_configured` VALUES (760,16,157,1,1,'@&Number_2197','Excel file');
INSERT INTO `script_has_been_configured` VALUES (761,16,158,1,1,'@&Number_2197','Excel file');
INSERT INTO `script_has_been_configured` VALUES (762,16,158,2,1,'@&Number_2147','Excel file');
INSERT INTO `script_has_been_configured` VALUES (763,16,158,3,1,'@&Number_2157','Excel file');
INSERT INTO `script_has_been_configured` VALUES (764,16,158,0,1,'@&Number_217','Excel file');
INSERT INTO `script_has_been_configured` VALUES (765,16,158,4,1,'@&Number_2227','Excel file');
INSERT INTO `script_has_been_configured` VALUES (766,16,158,5,1,'@&Number_2327','Excel file');
INSERT INTO `script_has_been_configured` VALUES (767,16,158,6,1,'@&Number_2337','Excel file');
INSERT INTO `script_has_been_configured` VALUES (768,44,159,3,1,'1','Constant');
INSERT INTO `script_has_been_configured` VALUES (769,29,159,1,1,'@&Number_2987','Excel file');
INSERT INTO `script_has_been_configured` VALUES (770,45,159,4,1,'1','Constant');
INSERT INTO `script_has_been_configured` VALUES (771,43,159,2,1,'1','Constant');
INSERT INTO `script_has_been_configured` VALUES (772,10,159,0,1,'Trigger Level 3','Constant');
INSERT INTO `script_has_been_configured` VALUES (773,45,160,4,1,'1','Constant');
INSERT INTO `script_has_been_configured` VALUES (774,10,160,0,1,'Trigger 0','Constant');
INSERT INTO `script_has_been_configured` VALUES (775,29,160,1,1,'@&Number_2987','Excel file');
INSERT INTO `script_has_been_configured` VALUES (776,43,160,2,1,'0','Constant');
INSERT INTO `script_has_been_configured` VALUES (777,44,160,3,1,'0','Constant');
INSERT INTO `script_has_been_configured` VALUES (778,16,161,5,1,'@&Number_2267','Excel file');
INSERT INTO `script_has_been_configured` VALUES (779,16,161,2,1,'@&Number_2147','Excel file');
INSERT INTO `script_has_been_configured` VALUES (780,16,161,1,1,'@&Number_2197','Excel file');
INSERT INTO `script_has_been_configured` VALUES (781,16,161,4,1,'@&Number_2227','Excel file');
INSERT INTO `script_has_been_configured` VALUES (782,16,161,6,1,'@&Number_2277','Excel file');
INSERT INTO `script_has_been_configured` VALUES (783,16,161,3,1,'@&Number_2157','Excel file');
INSERT INTO `script_has_been_configured` VALUES (784,16,161,0,1,'@&Number_217','Excel file');
CREATE TABLE script_executions (idscript_executions  integer, script_idScript integer not null, step_executions_idstep_executions integer not null, script_order tinyint, is_stimuli tinyint, primary key (idscript_executions));
...
CREATE TABLE script_execution_result (script_executions_idscript_executions integer not null, iteration_number tinyint not null, result varchar(6) not null, comment varchar(65535), primary key (script_executions_idscript_executions, iteration_number));
...
Search occurrence: OK 
Search occurrence: OK ');
CREATE TABLE script (idScript  integer, name varchar(50), desciption varchar(65535), script_version integer, creation_date longvarchar, edition_date longvarchar, is_stimuli tinyint, is_macro tinyint, call_name varchar(45), primary key (idScript));
...
CREATE TABLE requirement (idrequirement  integer, version tinyint not null, category varchar(20), requirement_id varchar(15), writer varchar(20), requirement_text varchar(65535), coverage smallint, comment varchar(65535), iadt varchar(15), primary key (idrequirement));
CREATE TABLE parameters_execution (idparameters  integer, parameters_idparameters integer not null, script_executions_idscript_executions integer not null, value varchar(100), param_order tinyint, primary key (idparameters));
...
CREATE TABLE parameters (idparameters  integer, name varchar(45), parameter_type varchar(20), description varchar(65535), primary key (idparameters));
...
CREATE TABLE param_script_macro (param_script_macrocol  integer, macro_idmacro integer not null, param_script_macro_param_script_macrocol integer, script_has_parameters_idscript_has_parameters integer not null, to_display tinyint, value_path varchar(150), value varchar(150), param_order tinyint, primary key (param_script_macrocol));
...
CREATE TABLE macro_execution (idmacro_execution  integer, script_executions_idscript_executions integer not null, script_executions_idscript_executions1 integer not null, script_order tinyint, primary key (idmacro_execution));
CREATE TABLE macro (idmacro  integer, script_idScript integer not null, script_idScript1 integer not null, script_order tinyint, primary key (idmacro));
...
CREATE TABLE iterations (iditerations  integer, test_campaign_idtest_campaign integer not null, baseline_id varchar(20) not null, iteration_number integer not null, date varchar(10), iteration_result double, user varchar(45), primary key (iditerations));
...
CREATE TABLE case_executions_result (case_executions_idcase_executions integer not null, iteration_number tinyint not null, result varchar(6), comment varchar(65535), primary key (case_executions_idcase_executions, iteration_number));
...
CREATE TABLE case_executions (idcase_executions  integer, iterations_iditerations integer not null, test_case_idtest_case integer not null, case_order smallint, location varchar(20), test_category varchar(15), case_instance varchar(20), excel_path varchar(255), primary key (idcase_executions));
